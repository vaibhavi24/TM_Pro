...
const BlogCardComponent = ({ blogName, content, img, alternateCard }) => {
  return (
    <div
      className={` flex-1 shadow-[0px_0px_2px_rgba(0,_0,_0,_0.16)] rounded-lg bg-gray-700 overflow-hidden flex ${
        alternateCard ? "flex-row-reverse" : "flex-row"
      } items-start justify-between p-[25px] box-border max-w-full gap-4 text-left text-5xl text-white font-sub-heading `}
    >
